...
if largest1 is not None:
    print(f"Largest digit in {num1} is {largest1}")
    print(f"Smallest digit in {num1} is {smallest1}")

num2 = -5082
largest2, smallest2 = find_largest_smallest_digit(num2)
if largest2 is not None:
    print(f"Largest digit in {num2} is {largest2}")
    print(f"Smallest digit in {num2} is {smallest2}")
